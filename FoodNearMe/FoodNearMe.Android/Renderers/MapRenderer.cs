...
[assembly: ExportRenderer(typeof(FoodNearMe.Controls.Map), typeof(FoodNearMe.Droid.Renderers.MapRenderer))]
namespace FoodNearMe.Droid.Renderers
{
    public class MapRenderer : Xamarin.Forms.Maps.Android.MapRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Map> e)
        {
            ...
            {
                (e.OldElement as FoodNearMe.Controls.Map).CustomPins.CollectionChanged -= CustomPins_CollectionChanged;
            }
            (e.NewElement as FoodNearMe.Controls.Map).CustomPins.CollectionChanged += CustomPins_CollectionChanged;
        }
        ...
        {
            this.CreateNativePins(this.Element as Controls.Map);
        }
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                this.CreateNativePins(this.Element as FoodNearMe.Controls.Map);
                isDrawn = true;
            }
        }

        private void CreateNativePins(Controls.Map map)
        {
            if (NativeMap != null)
            {
                NativeMap.Clear();
